...
export class IFrameWebview extends BaseWebview<HTMLIFrameElement> implements Webview {
	...
	protected createElement(options: WebviewOptions) {
		...
		element.sandbox.add('allow-scripts', 'allow-top-navigation-by-user-activation', 'allow-same-origin', 'allow-top-navigation', 'allow-forms',  'allow-popups', 'allow-popups-to-escape-sandbox');
